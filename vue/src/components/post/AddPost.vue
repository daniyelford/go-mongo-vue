<template>
    <div class="container py-1">
      <b-form @submit.prevent="submitPost" enctype="multipart/form-data">
        <b-form-group label="media" class="mt-3">
          ...
          >
            ...
            <div
              v-else
              class="d-flex flex-wrap gap-3 justify-content-center mt-3"
            >
              <div
        ...
        <!-- title -->
        <b-form-group label="title" label-for="title" class="mt-3">
          <b-form-input
            id="title"
            v-model="title"
        ...
        <!-- description -->
        <b-form-group label="description" label-for="content" class="mt-3">
          <b-form-textarea
            id="content"
            v-model="content"
